...
const options = {
  ...
  headers: {
    ...
    Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIyYWM2NjJiMTNiZmM3MTIyNmJiZDAwYWNhYmQ5MDQ0ZSIsInN1YiI6IjY1YWQxYmMyMjVjZDg1MDBhY2NhNTdjZiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.PcJFaPC1MGlUoUdGA86T2Wgc3n2Rs5CaymENfXa-zaU'
  }
}
@Injectable({
  providedIn: 'root'
